...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/afterCheckout";
    public static String vnp_TmnCode = "51DS7XOZ";
    public static String vnp_HashSecret = "UQKUAPFIBRVTPJCKQRIXLNHPAMHVZVQM";
